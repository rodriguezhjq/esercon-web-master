...
import Projects from '../views/admin-project/projects.vue'
import NewProject from '../views/admin-project/add-new-project.vue'
import Users from '../views/admin-user/users.vue'
import NewUser from '../views/admin-user/add-new-user.vue'
...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: 'admin-project/add-new-project',
        name: 'add-new-project',
        component: NewProject
      },
      {
        path: 'admin-project/edit-project',
        name: 'edit-project',
        component: () => import('../views/admin-project/edit-project.vue')
      },
      {
        path: 'admin-project/resources',
        name: 'resources',
        component: () => import('../views/admin-project/resources.vue')
      },
      {
      ...
      {
        path: 'admin-rols/rols',
        name: 'rols',
        component: () => import('../views/admin-rols/rols.vue')
      },
      {
        path: 'admin-rols/permissions',
        name: 'permissions',
        component: () => import('../views/admin-rols/permissions.vue')
      },
      {
